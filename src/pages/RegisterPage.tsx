    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-card p-6 sm:p-8 shadow-sm">
          <h1 className="font-heading text-2xl sm:text-3xl font-bold mb-2 text-center">Criar conta</h1>
          <p className="text-muted-foreground text-sm text-center mb-8">Comece a criar seus projetos agora</p>
